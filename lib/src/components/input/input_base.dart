...
class _TextFieldSelectionGestureDetectorBuilder extends TextSelectionGestureDetectorBuilder {
  _TextFieldSelectionGestureDetectorBuilder({
    required TInputBaseState state,
  })  : _state = state,
        super(delegate: state);

  final TInputBaseState _state;
...
/// 改造自[TextField]组件
class TInputBase extends StatefulWidget {
  ...
  /// [TInputBase.noMaxLength] then only the current length is displayed.
  ///
  ...
  const TInputBase({
    ...
    this.placeholder,
        ...
        assert(maxLength == null || maxLength == TInputBase.noMaxLength || maxLength > 0),
  ...
  /// {@template tdesign.components.inputBase.decorationBuilder}
  /// 装饰构建器
  /// {@endtemplate}
  final TextDecorationBuilder? decorationBuilder;

  /// {@template tdesign.components.inputBase.controller}
  ...
  /// {@template tdesign.components.inputBase.focusNode}
  ...
  /// {@template tdesign.components.inputBase.textInputAction}
  ...
  /// {@template tdesign.components.inputBase.style}
  ...
  /// {@template tdesign.components.inputBase.toolbarOptions}
  ...
  /// {@template tdesign.components.inputBase.maxLength}
  /// The maximum number of characters (Unicode grapheme clusters) to allow in the
  /// the text field.
  ///
  /// If set, a character counter will be displayed below the
  /// field showing how many characters have been entered. If set to a number
  /// greater than 0, it will also display the maximum number allowed. If set
  /// to [TInputBase.noMaxLength] then only the current character count is displayed.
  ///
  /// After [maxLength] characters have been input, additional input
  /// is ignored, unless [maxLengthEnforcement] is set to
  /// [MaxLengthEnforcement.none].
  ...
  /// which is evaluated after the supplied [inputFormatters], if any.
  ///
  /// This value must be either null, [TInputBase.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [TInputBase.noMaxLength], then no limit will
  ...
  /// {@template tdesign.components.inputBase.enabled}
  ...
  /// {@template tdesign.components.inputBase.cursorColor}
  ...
  /// {@template tdesign.components.inputBase.backgroundCursorColor}
  ...
  /// {@template tdesign.components.inputBase.selectionHeightStyle}
  ...
  /// {@template tdesign.components.inputBase.selectionWidthStyle}
  ...
  /// {@template tdesign.components.inputBase.keyboardAppearance}
  /// The appearance of the keyboard.
  ///
  /// This setting is only honored on iOS devices.
  ///
  /// If unset, defaults to [TThemeData.brightness].
  /// {@endtemplate}
  ...
  /// {@template tdesign.components.inputBase.onTap}
  ...
  /// {@template tdesign.components.inputBase.mouseCursor}
  ...
  ///
  /// The [mouseCursor] is the only property of [TInputBase] that controls the
  ...
  /// {@template tdesign.components.inputBase.selectionColor}
  ...
  /// {@template tdesign.components.inputBase.restorationId}
  ...
  /// {@template tdesign.components.inputBase.forceLine}
  ...
  /// {@template tdesign.components.inputBase.placeholder}
  /// placeholder
  /// {@endtemplate}
  ...
  static SpellCheckConfiguration inferAndroidSpellCheckConfiguration(
    ...
    return configuration.copyWith(
      misspelledTextStyle: configuration.misspelledTextStyle ?? TInputBase.materialMisspelledTextStyle,
      spellCheckSuggestionsToolbarBuilder:
          configuration.spellCheckSuggestionsToolbarBuilder ?? TInputBase.defaultSpellCheckSuggestionsToolbarBuilder,
    );
  }

  @override
  State<TInputBase> createState() => TInputBaseState();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorProperty('backgroundCursorColor', backgroundCursorColor, defaultValue: null));
    ...
    properties.add(DiagnosticsProperty<bool>('forceLine', forceLine, defaultValue: true));
    properties.add(DiagnosticsProperty<String>('placeholder', placeholder, defaultValue: true));
  }
}

class TInputBaseState extends State<TInputBase>
  ...
  @override
  void didUpdateWidget(TInputBase oldWidget) {
  ...
  Widget build(BuildContext context) {
    assert(
      !(widget.style.inherit == false && (widget.style.fontSize == null || widget.style.textBaseline == null)),
    ...
    Widget child = RepaintBoundary(
      child: UnmanagedRestorationScope(
        ...
        child: EditableText(
          ...
          selectionColor: focusNode.hasFocus ? widget.selectionColor : null,
          ...
          backgroundCursorColor: widget.backgroundCursorColor ?? CupertinoColors.inactiveGray,
    ...
    if (widget.decorationBuilder != null) {
      child = AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget? child) {
          return widget.decorationBuilder!(TextDecorationContext(
            context: context,
            focusNode: focusNode,
            controller: controller,
            states: _materialState,
            child: child,
          ));
        },
        child: child,
