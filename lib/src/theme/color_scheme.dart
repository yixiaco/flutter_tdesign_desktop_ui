...
class TColorScheme {
  ...
  static TColorScheme get light {
    ...
    return TColorScheme(
      ...
      shadow1: [
        const BoxShadow(offset: Offset(1, 0), blurRadius: 10, color: Color(0x0C000000)),
        const BoxShadow(offset: Offset(4, 0), blurRadius: 5, color: Color(0x14000000)),
        const BoxShadow(offset: Offset(4, 0), blurRadius: 4, spreadRadius: -1, color: Color(0x1E000000)),
      ],
      shadow2: [
        const BoxShadow(offset: Offset(3, 0), blurRadius: 14, spreadRadius: 2, color: Color(0x0C000000)),
        const BoxShadow(offset: Offset(8, 0), blurRadius: 10, spreadRadius: 1, color: Color(0x0F000000)),
        const BoxShadow(offset: Offset(5, 0), blurRadius: 5, spreadRadius: -3, color: Color(0x19000000)),
      ],
      shadow3: [
        const BoxShadow(offset: Offset(6, 0), blurRadius: 30, spreadRadius: 5, color: Color(0x0C000000)),
        const BoxShadow(offset: Offset(16, 0), blurRadius: 24, spreadRadius: 2, color: Color(0x0A000000)),
        const BoxShadow(offset: Offset(8, 0), blurRadius: 10, spreadRadius: -5, color: Color(0x14000000)),
      ],
      shadowInsetTop: const BoxShadow(blurStyle: BlurStyle.inner, offset: Offset(.5, 0), blurRadius: 0, color: Color(0xFFDCDCDC)),
      shadowInsetRight: const BoxShadow(blurStyle: BlurStyle.inner, offset: Offset(0, .5), blurRadius: 0, color: Color(0xFFDCDCDC)),
      shadowInsetBottom: const BoxShadow(blurStyle: BlurStyle.inner, offset: Offset(-.5, 0), blurRadius: 0, color: Color(0xFFDCDCDC)),
      shadowInsetLeft: const BoxShadow(blurStyle: BlurStyle.inner, offset: Offset(0, -.5), blurRadius: 0, color: Color(0xFFDCDCDC)),
  ...
  static TColorScheme get dark {
    ...
    return TColorScheme(
      brandColor: brandColor,
      warningColor: TColors.orangeDark1,
      errorColor: TColors.redDark1,
      successColor: TColors.greenDark1,
      gray1: TColors.gray1,
      gray2: TColors.gray2,
      gray3: TColors.gray3,
      gray4: TColors.gray4,
      ...
      shadow1: [
        const BoxShadow(offset: Offset(4, 0), blurRadius: 6, color: Color(0x0F000000)),
        const BoxShadow(offset: Offset(1, 0), blurRadius: 10, color: Color(0x14000000)),
        const BoxShadow(offset: Offset(2, 0), blurRadius: 4, color: Color(0x1E000000)),
      ],
      shadow2: [
        const BoxShadow(offset: Offset(8, 0), blurRadius: 10, color: Color(0x1E000000)),
        const BoxShadow(offset: Offset(3, 0), blurRadius: 14, color: Color(0x19000000)),
        const BoxShadow(offset: Offset(5, 0), blurRadius: 5, color: Color(0x28000000)),
      ],
      shadow3: [
        const BoxShadow(offset: Offset(16, 0), blurRadius: 24, color: Color(0x23000000)),
        const BoxShadow(offset: Offset(6, 0), blurRadius: 30, color: Color(0x1E000000)),
        const BoxShadow(offset: Offset(8, 0), blurRadius: 10, color: Color(0x33000000)),
      ],
      shadowInsetTop: const BoxShadow(blurStyle: BlurStyle.inner, offset: Offset(.5, 0), blurRadius: 0, color: Color(0xFF5E5E5E)),
      shadowInsetRight: const BoxShadow(blurStyle: BlurStyle.inner, offset: Offset(0, .5), blurRadius: 0, color: Color(0xFF5E5E5E)),
      shadowInsetBottom: const BoxShadow(blurStyle: BlurStyle.inner, offset: Offset(-.5, 0), blurRadius: 0, color: Color(0xFF5E5E5E)),
      shadowInsetLeft: const BoxShadow(blurStyle: BlurStyle.inner, offset: Offset(0, -.5), blurRadius: 0, color: Color(0xFF5E5E5E)),
